...
SELECT prescription.npi, COUNT(total_claim_count) AS Total_Claims, prescriber.specialty_description
FROM prescription
LEFT JOIN prescriber
ON prescription.npi = prescriber.npi
GROUP BY prescription.npi, total_claim_count, prescriber.specialty_description
ORDER BY Total_Claims DESC;
